...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    #print(args.crop,args.score_threshold)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        #dataset = COCODetection(cfg.dataset.valid_images, cfg.dataset.valid_info,transform=BaseTransform(), has_gt=cfg.dataset.has_gt)
        dataset=None
        #prep_coco_cats()       
